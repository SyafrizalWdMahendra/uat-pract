...
import { searchFeedbackHistory, getFeedbackHistory, getFeedbackHistoryById, deleteFeedbackHistory, } from "../../modules/feedbacks/controllers/feedbackHistoryController";
const router = Router();
