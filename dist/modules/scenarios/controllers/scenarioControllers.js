...
const getScenarioDocs = async (req, res) => {
    ...
    if (!scenarios) {
        return responses(res, 404, "Scenario document not found for this project.", null);
    }
    return responses(res, 200, "Scenario docs successfully retrieved", scenarios);
};
export { createScenarios, getScenarios, updateScenarios, deleteScenarios, getScenarioDocs, };
