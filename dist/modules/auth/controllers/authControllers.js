...
export const register = async (req, res) => {
    try {
        ...
        if (!registValidation.success) {
            return responses(res, 400, "regist validation error", registValidation.error.format());
        }
...
export const login = async (req, res) => {
    try {
        ...
        if (!loginValidation.success) {
            return responses(res, 400, "login validation error", loginValidation.error.format());
        }
