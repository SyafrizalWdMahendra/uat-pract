...
CREATE TABLE `User` (
    ...
    `role` ENUM('users', 'test_lead', 'manager') NOT NULL,
...
CREATE TABLE `Project` (
    ...
    `status` ENUM('active', 'inactive', 'completed', 'pending') NOT NULL,
...
CREATE TABLE `Feature` (
    ...
    UNIQUE INDEX `Feature_title_project_id_key`(`title`, `project_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TestScenarioDocs` (
    ...
    UNIQUE INDEX `TestScenarioDocs_project_id_key`(`project_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
